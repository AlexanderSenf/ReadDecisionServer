 ...
 * @author asenf
 */
public class ReadDecisionService {
    ...
    public ReadDecisionService(int port, int cores, String indexPath, String maskPath) {
        ReadDecisionService.port = port;
        ...
        try {
            ...
            Logger.getLogger(ReadDecisionService.class.getName()).log(Level.SEVERE, null, ex);
        }

        long maskSize = 1024L*1024L*1024L*2L;  // 2GB
    ...
    public void run() throws Exception {
        ...
        try {
            ...
            b.group(acceptGroup, connectGroup)
             ...
             .childHandler(new ReadDecisionServiceInitializer(this.l, this.s, this.mem, this.mask, this));
    ...
    public static void main(String[] args) {
        ...
        try {
            new ReadDecisionService(pi, cores, indexPath, maskPath).run();
        } catch (Exception ex) {
            Logger.getLogger(ReadDecisionService.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
